export const products = {
    ...
    'Headphones': {
        'Cowin': {
            'Cowin E7': {
                'image': 'https://i.ibb.co/WGFmSJQ/cowin-e7.jpg',
                'details': {
                    'Model name': 'E7ANC',
                    'Color': 'Black',
                    ...
                    'Additional Features': 'Comfortable Over-ear, Hi-Fi stereo, Deep Bass, Lightweight'
        ...
        'Tao Tronics': {
            'BH090': {
                'image': 'https://i.ibb.co/vqmQ738/tao-tronics.jpg',
                'details': {
                    'Model name': 'TT-BH090',
                    'Color': 'Black',
                    ...
                    'Connector type': '3.5mm',
                    'Included components': '1 X Usb Charging Cable 1 X 3.5Mm Audio Cable 1 X Carrying Case',
                    'Sound': '40mm dynamic drive',
                },
                'price': 69.99,
                'quantity': 0
            }
        ...
        'Peoh Zarr': {
            'WGYP 063': {
                'image': 'https://i.ibb.co/swzcRwX/peoh-zarr.jpg',
                'details': {
                    'Model name': 'WGYP-063',
                    'Color': 'Red',
                    'Driver size': '40mm',
                    'Fit type': 'On Ear',
                    'Suitable age': 'Kids Teens Adult',
                    'Additional features': 'Light Weight & Foldable, Built-in Mic',
                    'Microphone': 'Yes',
                    'Connector type': '3.5mm',
                },
                'price': 13.99,
